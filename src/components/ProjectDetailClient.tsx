      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        <div className="bg-white dark:bg-[#161b22] rounded-xl border border-gray-200 dark:border-[#30363d] shadow-lg p-4 sm:p-6 lg:p-8">
          ...
          <Button
            ...
            className="inline-flex items-center text-zinc-600 dark:text-[#8b949e] hover:text-zinc-900 dark:hover:text-[#f0f6fc] mb-6 sm:mb-8 transition-colors text-sm pl-0 hover:bg-transparent"
          >
